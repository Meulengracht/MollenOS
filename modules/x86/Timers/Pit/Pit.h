...
/* Sleepy Functions */
_CRT_EXTERN uint64_t PitGetClocks(void *Data);
_CRT_EXTERN void PitSleep(void *Data, uint32_t MilliSeconds);
_CRT_EXTERN void PitStall(void *Data, uint32_t MilliSeconds);
