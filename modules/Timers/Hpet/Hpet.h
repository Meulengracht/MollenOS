...
/* Sleep & Stall */
__EXTERN uint64_t HpetGetClocks(void* Device);
__EXTERN void HpetSleep(void* Device, size_t MilliSeconds);
__EXTERN void HpetStall(void* Device, size_t MilliSeconds);
