...
class Matrix2 {
public:
    Matrix2(float X, float Y) { m_Values[0] = X; m_Values[1] = Y; }
    ~Matrix2() { }
...
class Matrix3 {
public:
    Matrix3(float X, float Y, float Z) { m_Values[0] = X; m_Values[1] = Y; m_Values[2] = Z; }
    ~Matrix3() { }
...
class Matrix4 {
public:
    Matrix4(float X, float Y, float Z, float W) { m_Values[0] = X; m_Values[1] = Y; m_Values[2] = Z; m_Values[3] = W; }
    ~Matrix4() { }
