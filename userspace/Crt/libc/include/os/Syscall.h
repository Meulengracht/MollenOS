...
#define MOLLENOS_SYSCALL_VFSMOVE			0x2F
#define MOLLENOS_SYSCALL_VFSQUERY			0x30

#define MOLLENOS_SYSCALL_DEVQUERY			0x33

#define MOLLENOS_SYSCALL_ENDBOOT			0x3D
#define MOLLENOS_SYSCALL_REGWM				0x3E
