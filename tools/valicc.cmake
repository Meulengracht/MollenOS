...
set(CMAKE_C_CREATE_SHARED_LIBRARY "<CMAKE_C_COMPILER> <CMAKE_SHARED_LIBRARY_C_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> -Xlinker -implib:<TARGET_IMPLIB> -Xlinker -lldmap -Xlinker -version:<TARGET_VERSION_MAJOR>.<TARGET_VERSION_MINOR> <CMAKE_SHARED_LIBRARY_CREATE_C_FLAGS> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>")
set(CMAKE_C_CREATE_SHARED_MODULE ${CMAKE_C_CREATE_SHARED_LIBRARY})
set(CMAKE_C_LINK_EXECUTABLE "<CMAKE_C_COMPILER> <FLAGS> <CMAKE_C_LINK_FLAGS> <LINK_FLAGS> -Xlinker -lldmap -Xlinker -version:<TARGET_VERSION_MAJOR>.<TARGET_VERSION_MINOR> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
...
set(CMAKE_CXX_CREATE_SHARED_LIBRARY "<CMAKE_CXX_COMPILER> <CMAKE_SHARED_LIBRARY_CXX_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> -Xlinker -implib:<TARGET_IMPLIB> -Xlinker -lldmap -Xlinker -version:<TARGET_VERSION_MAJOR>.<TARGET_VERSION_MINOR> <CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>")
set(CMAKE_CXX_CREATE_SHARED_MODULE ${CMAKE_C_CREATE_SHARED_LIBRARY})
set(CMAKE_CXX_LINK_EXECUTABLE "<CMAKE_CXX_COMPILER> <FLAGS> <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> -Xlinker -lldmap -Xlinker -version:<TARGET_VERSION_MAJOR>.<TARGET_VERSION_MINOR> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
