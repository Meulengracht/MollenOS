 ...
 * timeout to 0 */
KERNELAPI void SchedulerSleepThread(uintptr_t *Resource, size_t Timeout);

/* These two functions either wakes one or all threads
 * waiting for a resource. */
KERNELAPI int SchedulerWakeupOneThread(uintptr_t *Resource);
KERNELAPI void SchedulerWakeupAllThreads(uintptr_t *Resource);
