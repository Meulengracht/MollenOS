...
TestDataStructures(void *Unused)
{
    ...
    TRACE(" > Allocation (1000) => %" PRIuIN "", Allocation);
    TRACE(" > Allocation (300) => %" PRIuIN "", Allocation1);
    ...
    TRACE(" > Allocation (120) => %" PRIuIN "", Allocation1);
    TRACE(" > Allocation (3000) => %" PRIuIN "", Allocation);
