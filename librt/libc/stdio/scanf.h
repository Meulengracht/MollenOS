...
#define _LOCK_FILE_(file) flockfile(stdin)
#define _UNLOCK_FILE_(file) funlockfile(stdin)
#ifdef WIDE_SCANF
#ifdef SECURE
...
#define _LOCK_FILE_(file) flockfile(file)
#define _UNLOCK_FILE_(file) funlockfile(file)
#ifdef SECURE
