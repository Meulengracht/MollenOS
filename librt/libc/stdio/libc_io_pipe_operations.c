...
OsStatus_t stdio_pipe_op_read(stdio_handle_t* handle, const void* buffer, size_t length, size_t* bytes_read)
{
    return OsSuccess;
}

OsStatus_t stdio_pipe_op_write(stdio_handle_t* handle, void* buffer, size_t length, size_t* bytes_written)
{
    return OsSuccess;
}
