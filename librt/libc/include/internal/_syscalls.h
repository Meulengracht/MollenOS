...
#define Syscall_MemoryAllocate(Hint, Size, Flags, MemoryOut)               (OsStatus_t)syscall4(45, SCPARAM(Hint), SCPARAM(Size), SCPARAM(Flags), SCPARAM(MemoryOut))
#define Syscall_MemoryFree(Pointer, Size)                                  (OsStatus_t)syscall2(46, SCPARAM(Pointer), SCPARAM(Size))
#define Syscall_MemoryProtect(MemoryPointer, Length, Flags, PreviousFlags) (OsStatus_t)syscall4(47, SCPARAM(MemoryPointer), SCPARAM(Length), SCPARAM(Flags), SCPARAM(PreviousFlags))
#define Syscall_MemoryQueryAllocation(MemoryPointer, Descriptor)           (OsStatus_t)syscall2(48, SCPARAM(MemoryPointer), SCPARAM(Descriptor))
#define Syscall_MemoryQueryAttributes(MemoryPointer, Length, Attributes)   (OsStatus_t)syscall3(49, SCPARAM(MemoryPointer), SCPARAM(Length), SCPARAM(Attributes))
...
#define Syscall_DmaAttachmentCommit(Attachment, Address, Length)           (OsStatus_t)syscall3(56, SCPARAM(Attachment), SCPARAM(Address), SCPARAM(Length))
...
#define Syscall_DmaGetMetrics(Handle, SizeOut, VectorsOut)                 (OsStatus_t)syscall3(59, SCPARAM(Handle), SCPARAM(SizeOut), SCPARAM(VectorsOut))
...
#define Syscall_ControlHandleSet(SetHandle, Operation, Handle, Event)      (OsStatus_t)syscall4(66, SCPARAM(SetHandle), SCPARAM(Operation), SCPARAM(Handle), SCPARAM(Event))
#define Syscall_ListenHandleSet(Handle, WaitContext, EventsOut)            (OsStatus_t)syscall3(67, SCPARAM(Handle), SCPARAM(WaitContext), SCPARAM(EventsOut))
