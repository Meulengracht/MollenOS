...
#define Syscall_ConditionCreate(Handle) (OsStatus_t)syscall1(46, SCPARAM(Handle))
#define Syscall_ConditionDestroy(Handle) (OsStatus_t)syscall1(47, SCPARAM(Handle))
#define Syscall_WaitForObject(Handle, Timeout) (OsStatus_t)syscall2(48, SCPARAM(Handle), SCPARAM(Timeout))
#define Syscall_SignalHandle(Handle) (OsStatus_t)syscall1(49, SCPARAM(Handle))
#define Syscall_BroadcastHandle(Handle) (OsStatus_t)syscall1(50, SCPARAM(Handle))

#define Syscall_CreatePipe(Flags, HandleOut) (OsStatus_t)syscall2(51, SCPARAM(Flags), SCPARAM(HandleOut))
#define Syscall_DestroyPipe(Handle) (OsStatus_t)syscall1(52, SCPARAM(Handle))
#define Syscall_ReadPipe(Handle, Buffer, Length) (OsStatus_t)syscall3(53, SCPARAM(Handle), SCPARAM(Buffer), SCPARAM(Length))
#define Syscall_WritePipe(Handle, Buffer, Length) (OsStatus_t)syscall3(54, SCPARAM(Handle), SCPARAM(Buffer), SCPARAM(Length))

#define Syscall_RemoteCall(RemoteCall, Asynchronous) (OsStatus_t)syscall2(55, SCPARAM(RemoteCall), SCPARAM(Asynchronous))
#define Syscall_RpcGetResponse(RemoteCall) (OsStatus_t)syscall1(56, SCPARAM(RemoteCall))
#define Syscall_RemoteCallWait(RemoteCall, ArgumentBuffer) (OsStatus_t)syscall2(57, SCPARAM(RemoteCall), SCPARAM(ArgumentBuffer))
#define Syscall_RemoteCallRespond(RemoteAddress, Buffer, Length) (OsStatus_t)syscall3(58, SCPARAM(RemoteAddress), SCPARAM(Buffer), SCPARAM(Length))

#define Syscall_MemoryAllocate(Size, Flags, Virtual, Physical) (OsStatus_t)syscall4(59, SCPARAM(Size), SCPARAM(Flags), SCPARAM(Virtual), SCPARAM(Physical))
#define Syscall_MemoryFree(Pointer, Size) (OsStatus_t)syscall2(60, SCPARAM(Pointer), SCPARAM(Size))
#define Syscall_MemoryProtect(MemoryPointer, Length, Flags, PreviousFlags) (OsStatus_t)syscall4(61, SCPARAM(MemoryPointer), SCPARAM(Length), SCPARAM(Flags), SCPARAM(PreviousFlags))
#define Syscall_CreateBuffer(Flags, Size, DmaBufferPointer) (OsStatus_t)syscall3(62, SCPARAM(Flags), SCPARAM(Size), SCPARAM(DmaBufferPointer))
#define Syscall_AcquireBuffer(Handle, DmaBufferPointer) (OsStatus_t)syscall2(63, SCPARAM(Handle), SCPARAM(DmaBufferPointer))
#define Syscall_QueryBuffer(Handle, DmaOut, CapacityOut) (OsStatus_t)syscall3(64, SCPARAM(Handle), SCPARAM(DmaOut), SCPARAM(CapacityOut))

#define Syscall_DestroyHandle(Handle) (OsStatus_t)syscall1(65, SCPARAM(Handle))
#define Syscall_InstallSignalHandler(HandlerAddress) (OsStatus_t)syscall1(66, SCPARAM(HandlerAddress))
#define Syscall_CreateMemoryHandler(Flags, Length, HandleOut, AddressOut) (OsStatus_t)syscall4(67, SCPARAM(Flags), SCPARAM(Length), SCPARAM(HandleOut), SCPARAM(AddressOut))
#define Syscall_DestroyMemoryHandler(Handle) (OsStatus_t)syscall1(68, SCPARAM(Handle))
