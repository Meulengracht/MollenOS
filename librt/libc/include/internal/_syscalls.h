...
#define Syscall_SystemTimeTick(Source, TickOut)                            (OsStatus_t)syscall2(62, SCPARAM(Source), SCPARAM(TickOut))
#define Syscall_SystemTimeFrequency(Source, FrequencyOut)                  (OsStatus_t)syscall2(63, SCPARAM(Source), SCPARAM(FrequencyOut))
#define Syscall_SystemTime(Time)                                           (OsStatus_t)syscall1(64, SCPARAM(Time))
