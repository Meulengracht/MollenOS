...
#define Syscall_IpcContextCreate(Size, HandleOut, UserContextOut)          (OsStatus_t)syscall3(42, SCPARAM(Size), SCPARAM(HandleOut), SCPARAM(UserContextOut))
#define Syscall_IpcContextSend(Messages, MessageCount, Timeout)            (OsStatus_t)syscall3(43, SCPARAM(Messages), SCPARAM(MessageCount), SCPARAM(Timeout))
#define Syscall_IpcContextRespond(Replies, ReplyMessages, Count)           (OsStatus_t)syscall3(44, SCPARAM(Replies), SCPARAM(ReplyMessages), SCPARAM(Count))
...
#define Syscall_DmaCreate(CreateInfo, Attachment)                          (OsStatus_t)syscall2(48, SCPARAM(CreateInfo), SCPARAM(Attachment))
#define Syscall_DmaExport(Buffer, ExportInfo, Attachment)                  (OsStatus_t)syscall3(49, SCPARAM(Buffer), SCPARAM(ExportInfo), SCPARAM(Attachment))
#define Syscall_DmaAttach(Handle, Attachment)                              (OsStatus_t)syscall2(50, SCPARAM(Handle), SCPARAM(Attachment))
#define Syscall_DmaAttachmentMap(Attachment)                               (OsStatus_t)syscall1(51, SCPARAM(Attachment))
#define Syscall_DmaAttachmentResize(Attachment, Length)                    (OsStatus_t)syscall2(52, SCPARAM(Attachment), SCPARAM(Length))
...
#define Syscall_RegisterHandlePath(Handle, Path)                           (OsStatus_t)syscall2(59, SCPARAM(Handle), SCPARAM(Path))
#define Syscall_LookupHandle(Path, HandleOut)                              (OsStatus_t)syscall2(60, SCPARAM(Path), SCPARAM(HandleOut))
