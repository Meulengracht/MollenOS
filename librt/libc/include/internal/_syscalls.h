...
#define Syscall_LibraryLoad(Path, HandleOut, EntryAddressOut)                                (OsStatus_t)syscall3(7, SCPARAM(Path), SCPARAM(HandleOut), SCPARAM(EntryAddressOut))
...
#define Syscall_MemoryQueryAllocation(MemoryPointer, Descriptor)           (OsStatus_t)syscall2(49, SCPARAM(MemoryPointer), SCPARAM(Descriptor))
#define Syscall_MemoryQueryAttributes(MemoryPointer, Length, Attributes)   (OsStatus_t)syscall3(50, SCPARAM(MemoryPointer), SCPARAM(Length), SCPARAM(Attributes))

#define Syscall_DmaCreate(CreateInfo, Attachment)                          (OsStatus_t)syscall2(51, SCPARAM(CreateInfo), SCPARAM(Attachment))
#define Syscall_DmaExport(Buffer, ExportInfo, Attachment)                  (OsStatus_t)syscall3(52, SCPARAM(Buffer), SCPARAM(ExportInfo), SCPARAM(Attachment))
#define Syscall_DmaAttach(Handle, Attachment)                              (OsStatus_t)syscall2(53, SCPARAM(Handle), SCPARAM(Attachment))
#define Syscall_DmaAttachmentMap(Attachment, AccessFlags)                  (OsStatus_t)syscall2(54, SCPARAM(Attachment), SCPARAM(AccessFlags))
#define Syscall_DmaAttachmentResize(Attachment, Length)                    (OsStatus_t)syscall2(55, SCPARAM(Attachment), SCPARAM(Length))
#define Syscall_DmaAttachmentRefresh(Attachment)                           (OsStatus_t)syscall1(56, SCPARAM(Attachment))
#define Syscall_DmaAttachmentCommit(Attachment, Address, Length)           (OsStatus_t)syscall3(57, SCPARAM(Attachment), SCPARAM(Address), SCPARAM(Length))
#define Syscall_DmaAttachmentUnmap(Attachment)                             (OsStatus_t)syscall1(58, SCPARAM(Attachment))
#define Syscall_DmaDetach(Attachment)                                      (OsStatus_t)syscall1(59, SCPARAM(Attachment))
#define Syscall_DmaGetMetrics(Handle, SizeOut, VectorsOut)                 (OsStatus_t)syscall3(60, SCPARAM(Handle), SCPARAM(SizeOut), SCPARAM(VectorsOut))

#define Syscall_CreateHandle(HandleOut)                                    (OsStatus_t)syscall1(61, SCPARAM(HandleOut))
#define Syscall_DestroyHandle(Handle)                                      (OsStatus_t)syscall1(62, SCPARAM(Handle))
#define Syscall_RegisterHandlePath(Handle, Path)                           (OsStatus_t)syscall2(63, SCPARAM(Handle), SCPARAM(Path))
#define Syscall_LookupHandle(Path, HandleOut)                              (OsStatus_t)syscall2(64, SCPARAM(Path), SCPARAM(HandleOut))
#define Syscall_HandleSetActivity(Handle, Flags)                           (OsStatus_t)syscall2(65, SCPARAM(Handle), SCPARAM(Flags))

#define Syscall_CreateHandleSet(Flags, HandleOut)                          (OsStatus_t)syscall2(66, SCPARAM(Flags), SCPARAM(HandleOut))
#define Syscall_ControlHandleSet(SetHandle, Operation, Handle, Event)      (OsStatus_t)syscall4(67, SCPARAM(SetHandle), SCPARAM(Operation), SCPARAM(Handle), SCPARAM(Event))
#define Syscall_ListenHandleSet(Handle, WaitContext, EventsOut)            (OsStatus_t)syscall3(68, SCPARAM(Handle), SCPARAM(WaitContext), SCPARAM(EventsOut))
