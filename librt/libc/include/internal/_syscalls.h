...
#define Syscall_MemoryShare(Length, Capacity, MemoryOut, HandleOut)        (OsStatus_t)syscall4(60, SCPARAM(Length), SCPARAM(Capacity), SCPARAM(MemoryOut), SCPARAM(HandleOut))
#define Syscall_MemoryInherit(Handle, MemoryOut, LengthOut, CapacityOut)   (OsStatus_t)syscall4(61, SCPARAM(Handle), SCPARAM(MemoryOut), SCPARAM(LengthOut), SCPARAM(CapacityOut))
#define Syscall_MemoryResize(Handle, Memory, Length)                       (OsStatus_t)syscall3(62, SCPARAM(Handle), SCPARAM(Memory), SCPARAM(Length))
#define Syscall_MemoryRefresh(Handle, Memory, CurrentLength)               (OsStatus_t)syscall3(63, SCPARAM(Handle), SCPARAM(Memory), SCPARAM(CurrentLength))
#define Syscall_MemoryGetSharedMetrics(Handle, SizeOut, VectorsOut)        (OsStatus_t)syscall3(64, SCPARAM(Handle), SCPARAM(SizeOut), SCPARAM(VectorsOut))
