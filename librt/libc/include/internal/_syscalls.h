...
#define Syscall_BufferCreate(InitialSize, Capacity, Flags, HandleOut, BufferOut) (OsStatus_t)syscall5(60, SCPARAM(InitialSize), SCPARAM(Capacity), SCPARAM(Flags), SCPARAM(HandleOut), SCPARAM(BufferOut))
#define Syscall_BufferInherit(Handle, BufferOut)                           (OsStatus_t)syscall2(61, SCPARAM(Handle), SCPARAM(BufferOut))
#define Syscall_BufferResize(Handle, Buffer, Size)                         (OsStatus_t)syscall3(62, SCPARAM(Handle), SCPARAM(Buffer), SCPARAM(Size))
#define Syscall_BufferGetMetrics(Handle, SizeOut, CapacityOut)             (OsStatus_t)syscall3(63, SCPARAM(Handle), SCPARAM(SizeOut), SCPARAM(CapacityOut))
#define Syscall_BufferGetVectors(Handle, VectorsOut)                       (OsStatus_t)syscall2(64, SCPARAM(Handle), SCPARAM(VectorsOut))
...
#define Syscall_GetSignalOriginalContext(Context)                          (OsStatus_t)syscall1(67, SCPARAM(Context))
