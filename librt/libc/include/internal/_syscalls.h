...
#define Syscall_MemoryProtect(MemoryPointer, Length, Flags, PreviousFlags) (OsStatus_t)syscall4(50, SCPARAM(MemoryPointer), SCPARAM(Length), SCPARAM(Flags), SCPARAM(PreviousFlags))
...
#define Syscall_DmaAttachmentMap(Attachment)                               (OsStatus_t)syscall1(54, SCPARAM(Attachment))
...
#define Syscall_DmaAttachmentUnmap(Attachment)                             (OsStatus_t)syscall1(57, SCPARAM(Attachment))
#define Syscall_DmaDetach(Attachment)                                      (OsStatus_t)syscall1(58, SCPARAM(Attachment))
#define Syscall_DmaGetMetrics(Attachment, SizeOut, VectorsOut)             (OsStatus_t)syscall3(59, SCPARAM(Attachment), SCPARAM(SizeOut), SCPARAM(VectorsOut))

#define Syscall_CreateHandle(HandleOut)                                    (OsStatus_t)syscall1(60, SCPARAM(HandleOut))
#define Syscall_DestroyHandle(Handle)                                      (OsStatus_t)syscall1(61, SCPARAM(Handle))
#define Syscall_RegisterHandlePath(Handle, Path)                           (OsStatus_t)syscall2(62, SCPARAM(Handle), SCPARAM(Path))
#define Syscall_LookupHandle(Path, HandleOut)                              (OsStatus_t)syscall2(63, SCPARAM(Path), SCPARAM(HandleOut))
#define Syscall_HandleSetActivity(Handle, Flags)                           (OsStatus_t)syscall2(64, SCPARAM(Handle), SCPARAM(Flags))

#define Syscall_CreateHandleSet(Flags, HandleOut)                          (OsStatus_t)syscall2(65, SCPARAM(Flags), SCPARAM(HandleOut))
#define Syscall_ControlHandleSet(SetHandle, Operation, Handle, Flags, Ctx) (OsStatus_t)syscall5(66, SCPARAM(SetHandle), SCPARAM(Operation), SCPARAM(Handle), SCPARAM(Flags), SCPARAM(Ctx))
#define Syscall_ListenHandleSet(Handle, Events, MaxEvents, Timeout, Count) (OsStatus_t)syscall5(67, SCPARAM(Handle), SCPARAM(Events), SCPARAM(MaxEvents), SCPARAM(Timeout), SCPARAM(Count))
...
#define Syscall_SystemQuery(SystemInformation)                             (OsStatus_t)syscall1(72, SCPARAM(SystemInformation))
