...
DDKDECL(oscode_t, AcpiQueryStatus(AcpiDescriptor_t * AcpiDescriptor));
...
DDKDECL(oscode_t, AcpiQueryTable(const char*signature, ACPI_TABLE_HEADER **tableOut));
...
DDKDECL(oscode_t, AcpiQueryInterrupt(unsigned int Bus, unsigned int Device, int Pin,
