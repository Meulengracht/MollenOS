...
#define FILE_PERMISSION_OTHER_READ    0x0008
#define FILE_PERMISSION_OTHER_WRITE   0x0010
#define FILE_PERMISSION_OTHER_EXECUTE 0x0020

#define FILE_PERMISSION_READ    (FILE_PERMISSION_OWNER_READ    | FILE_PERMISSION_OTHER_READ)
#define FILE_PERMISSION_WRITE   (FILE_PERMISSION_OWNER_WRITE   | FILE_PERMISSION_OTHER_WRITE)
