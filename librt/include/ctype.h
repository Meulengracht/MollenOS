...
#define	isxdigit_l(__c,__l)	(__ctype_lookup_l(__c,__l)&(_X|_CTYPE_N))
...
#define isprint_l(__c,__l)	(__ctype_lookup_l(__c,__l)&(_P|_CTYPE_U|_CTYPE_L|_CTYPE_N|_B))
#define	isgraph_l(__c,__l)	(__ctype_lookup_l(__c,__l)&(_P|_CTYPE_U|_CTYPE_L|_CTYPE_N))
