...
unwind_phase1(unw_context_t *uc, unw_cursor_t *cursor, struct _Unwind_Exception *exception_object) {
...
static _Unwind_Reason_Code
unwind_phase2(unw_context_t *uc, unw_cursor_t *cursor, struct _Unwind_Exception *exception_object) {
  unw_init_local(cursor, uc);
